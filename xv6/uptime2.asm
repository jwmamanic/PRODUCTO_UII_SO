...
_uptime2:     formato del fichero elf32-i386
...
int main(){
  ...
  if(getuptimeinfo(info) < 0){
  17:	50                   	push   %eax
  18:	e8 8e 03 00 00       	call   3ab <getuptimeinfo>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	78 71                	js     95 <main+0x95>
  ...
  27:	b9 64 00 00 00       	mov    $0x64,%ecx
  int running = info[1];
  2c:	8b 7d d8             	mov    -0x28(%ebp),%edi
  int runnable = info[2];
  2f:	8b 75 dc             	mov    -0x24(%ebp),%esi
  int sleeping = info[3];
  32:	8b 5d e0             	mov    -0x20(%ebp),%ebx
  int ctx = info[4];
  35:	89 45 c4             	mov    %eax,-0x3c(%ebp)
  printf(1, "Tiempo desde arranque: %d ticks (%d segundos)\n",
  38:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  3b:	99                   	cltd   
  3c:	f7 f9                	idiv   %ecx
  3e:	50                   	push   %eax
  3f:	ff 75 d4             	push   -0x2c(%ebp)
  42:	68 1c 08 00 00       	push   $0x81c
  47:	6a 01                	push   $0x1
...
000003ab <getuptimeinfo>:
SYSCALL(getuptimeinfo)
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 ac 08 00 00 	movzbl 0x8ac(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 54 08 00 00 	jmp    *0x854(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba 4b 08 00 00       	mov    $0x84b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 792:	00 00 00 
    if(p->s.size >= nunits){
