...
_psmen:     formato del fichero elf32-i386
...
main(void)
{
  ...
  struct uproc ps[64];
  int n = getps(ps, 64);
   f:	8d 85 e8 f8 ff ff    	lea    -0x718(%ebp),%eax
{
  15:	53                   	push   %ebx
  16:	51                   	push   %ecx
  ...
  1d:	6a 40                	push   $0x40
  1f:	50                   	push   %eax
  20:	e8 5e 03 00 00       	call   383 <getps>
  25:	89 c7                	mov    %eax,%edi

  printf(1, "PID   Estado      Mem(Bytes)   Nombre\n");
  27:	58                   	pop    %eax
  28:	5a                   	pop    %edx
  29:	68 78 07 00 00       	push   $0x778
  2e:	6a 01                	push   $0x1
  ...
  3a:	7e 39                	jle    75 <main+0x75>
  3c:	8d 9d f4 f8 ff ff    	lea    -0x70c(%ebp),%ebx
  ...
  4e:	53                   	push   %ebx
  for(int i=0; i<n; i++){
  4f:	83 c3 1c             	add    $0x1c,%ebx
    printf(1, "%d    %s     %d       %s\n",
  52:	ff 73 e0             	push   -0x20(%ebx)
  55:	8b 43 dc             	mov    -0x24(%ebx),%eax
  58:	ff 34 85 fc 0a 00 00 	push   0xafc(,%eax,4)
  5f:	ff 73 d8             	push   -0x28(%ebx)
  62:	68 9f 07 00 00       	push   $0x79f
  67:	6a 01                	push   $0x1
  69:	e8 e2 03 00 00       	call   450 <printf>
  for(int i=0; i<n; i++){
  6e:	83 c4 20             	add    $0x20,%esp
  71:	39 f7                	cmp    %esi,%edi
  73:	75 d3                	jne    48 <main+0x48>
      ps[i].sz,
      ps[i].name
    );
  }
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba e8 07 00 00       	mov    $0x7e8,%edx
        while(*s != 0){
 ...
 5f1:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 747:	0b 00 00 
    base.s.size = 0;
 74a:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 1c 0b 00 00 00 	movl   $0x0,0xb1c
 762:	00 00 00 
    if(p->s.size >= nunits){
