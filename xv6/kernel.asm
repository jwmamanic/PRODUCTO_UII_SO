...
80102088:	68 42 7c 10 80       	push   $0x80107c42
...
801024d2:	81 fb 70 55 11 80    	cmp    $0x80115570,%ebx
...
80103077:	68 70 55 11 80       	push   $0x80115570
...
801037b4:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 40 1d 11 80       	push   $0x80111d40
...
801037d3:	81 fb 74 3c 11 80    	cmp    $0x80113c74,%ebx
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 40 1d 11 80       	push   $0x80111d40
  p->pid = nextpid++;
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 d8 5a 10 80 	movl   $0x80105ad8,0x14(%eax)
  p->context = (struct context*)sp;
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 40 1d 11 80       	push   $0x80111d40
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 40 1d 11 80       	push   $0x80111d40
...
801038d6:	68 60 79 10 80       	push   $0x80107960
801038db:	68 40 1d 11 80       	push   $0x80111d40
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 74 3c 11 80       	mov    %eax,0x80113c74
  if((p->pgdir = setupkvm()) == 0)
801039b3:	e8 18 37 00 00       	call   801070d0 <setupkvm>
...
801039d1:	e8 aa 33 00 00       	call   80106d80 <inituvm>
...
80103a83:	68 77 79 10 80       	push   $0x80107977
...
80103abb:	e8 b0 31 00 00       	call   80106c70 <switchuvm>
  return 0;
...
80103ada:	e8 11 34 00 00       	call   80106ef0 <allocuvm>
...
80103afa:	e8 21 35 00 00       	call   80107020 <deallocuvm>
...
80103b48:	e8 73 36 00 00       	call   801071c0 <copyuvm>
...
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
80103bd0:	e8 cb 09 00 00       	call   801045a0 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb 74 1d 11 80       	mov    $0x80111d74,%ebx
    acquire(&ptable.lock);
80103c59:	68 40 1d 11 80       	push   $0x80111d40
...
80103c74:	75 3a                	jne    80103cb0 <scheduler+0x80>
      switchuvm(p);
...
80103c80:	e8 eb 2f 00 00       	call   80106c70 <switchuvm>
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      ncontext++;
80103c97:	83 05 20 1d 11 80 01 	addl   $0x1,0x80111d20
      switchkvm();
80103c9e:	e8 bd 2f 00 00       	call   80106c60 <switchkvm>
      c->proc = 0;
80103ca3:	83 c4 10             	add    $0x10,%esp
80103ca6:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103cad:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb0:	83 c3 7c             	add    $0x7c,%ebx
80103cb3:	81 fb 74 3c 11 80    	cmp    $0x80113c74,%ebx
80103cb9:	75 b5                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cbb:	83 ec 0c             	sub    $0xc,%esp
80103cbe:	68 40 1d 11 80       	push   $0x80111d40
80103cc3:	e8 78 08 00 00       	call   80104540 <release>
    sti();
80103cc8:	83 c4 10             	add    $0x10,%esp
80103ccb:	eb 83                	jmp    80103c50 <scheduler+0x20>
...
80103ced:	68 40 1d 11 80       	push   $0x80111d40
...
80103d99:	e8 d2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103d9e:	39 05 74 3c 11 80    	cmp    %eax,0x80113c74
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80103e2f:	3d 74 3c 11 80       	cmp    $0x80113c74,%eax
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
      p->parent = initproc;
80103e36:	8b 0d 74 3c 11 80    	mov    0x80113c74,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba 74 1d 11 80       	mov    $0x80111d74,%edx
80103e41:	eb 10                	jmp    80103e53 <exit+0xc3>
80103e43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e47:	90                   	nop
80103e48:	83 c2 7c             	add    $0x7c,%edx
80103e4b:	81 fa 74 3c 11 80    	cmp    $0x80113c74,%edx
...
80103e9d:	68 e8 79 10 80       	push   $0x801079e8
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 db 79 10 80       	push   $0x801079db
...
80103f11:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f16:	81 fb 74 3c 11 80    	cmp    $0x80113c74,%ebx
...
80103f89:	e8 c2 30 00 00       	call   80107050 <freevm>
        p->pid = 0;
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 40 1d 11 80       	push   $0x80111d40
...
80103fe0:	68 f4 79 10 80       	push   $0x801079f4
...
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
80104070:	81 fe 40 1d 11 80    	cmp    $0x80111d40,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 40 1d 11 80       	push   $0x80111d40
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 40 1d 11 80 	movl   $0x80111d40,(%esp)
...
801040e9:	68 fa 79 10 80       	push   $0x801079fa
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 f4 79 10 80       	push   $0x801079f4
...
8010413f:	3d 74 3c 11 80       	cmp    $0x80113c74,%eax
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 40 1d 11 80 	movl   $0x80111d40,0x8(%ebp)
}
...
801041a6:	68 40 1d 11 80       	push   $0x80111d40
...
801041c3:	68 40 1d 11 80       	push   $0x80111d40
...
801041e9:	bb e0 1d 11 80       	mov    $0x80111de0,%ebx
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba 0b 7a 10 80       	mov    $0x80107a0b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 6c 7a 10 80 	mov    -0x7fef8594(,%eax,4),%edx
      state = "???";
8010422f:	b8 0b 7a 10 80       	mov    $0x80107a0b,%eax
...
8010423e:	68 0f 7a 10 80       	push   $0x80107a0f
...
8010427d:	68 61 74 10 80       	push   $0x80107461
...
801042aa:	68 84 7a 10 80       	push   $0x80107a84
...
801044e5:	68 8f 7a 10 80       	push   $0x80107a8f
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 a6 7a 10 80       	push   $0x80107aa6
...
8010455b:	68 ad 7a 10 80       	push   $0x80107aad
...
80104650:	68 b5 7a 10 80       	push   $0x80107ab5
...
80104a6e:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
80104a70:	8b 40 18             	mov    0x18(%eax),%eax
80104a73:	8b 70 1c             	mov    0x1c(%eax),%esi

  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a76:	8d 46 ff             	lea    -0x1(%esi),%eax
80104a79:	83 f8 18             	cmp    $0x18,%eax
80104a7c:	0f 87 b6 00 00 00    	ja     80104b38 <syscall+0xd8>
80104a82:	8b 04 b5 40 7b 10 80 	mov    -0x7fef84c0(,%esi,4),%eax
80104a89:	85 c0                	test   %eax,%eax
80104a8b:	0f 84 a7 00 00 00    	je     80104b38 <syscall+0xd8>

    syscall_count[num]++;
80104a91:	83 04 b5 80 3c 11 80 	addl   $0x1,-0x7feec380(,%esi,4)
80104a98:	01 
    curproc->tf->eax = syscalls[num]();
80104a99:	ff d0                	call   *%eax
80104a9b:	89 c2                	mov    %eax,%edx
80104a9d:	8b 43 18             	mov    0x18(%ebx),%eax
80104aa0:	89 50 1c             	mov    %edx,0x1c(%eax)
    // --- Instrumentación ---
    if(trace_syscalls){
80104aa3:	a1 e8 3c 11 80       	mov    0x80113ce8,%eax
80104aa8:	85 c0                	test   %eax,%eax
80104aaa:	0f 84 a7 00 00 00    	je     80104b57 <syscall+0xf7>
      cprintf("[syscall] %s(", syscall_names[num]);
80104ab0:	83 ec 08             	sub    $0x8,%esp
80104ab3:	ff 34 b5 c0 7b 10 80 	push   -0x7fef8440(,%esi,4)
      for(int i = 0; i < 3; i++){
80104aba:	31 db                	xor    %ebx,%ebx
      cprintf("[syscall] %s(", syscall_names[num]);
80104abc:	68 bd 7a 10 80       	push   $0x80107abd
80104ac1:	e8 da bb ff ff       	call   801006a0 <cprintf>
80104ac6:	83 c4 10             	add    $0x10,%esp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ac9:	e8 a2 ee ff ff       	call   80103970 <myproc>
80104ace:	8b 40 18             	mov    0x18(%eax),%eax
80104ad1:	8b 40 44             	mov    0x44(%eax),%eax
80104ad4:	8d 34 98             	lea    (%eax,%ebx,4),%esi
  struct proc *curproc = myproc();
80104ad7:	e8 94 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104adc:	8d 7e 04             	lea    0x4(%esi),%edi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104adf:	8b 00                	mov    (%eax),%eax
80104ae1:	39 c7                	cmp    %eax,%edi
80104ae3:	73 2f                	jae    80104b14 <syscall+0xb4>
80104ae5:	8d 56 08             	lea    0x8(%esi),%edx
80104ae8:	39 d0                	cmp    %edx,%eax
80104aea:	72 28                	jb     80104b14 <syscall+0xb4>
        int arg;
        if(argint(i, &arg) >= 0){
          cprintf("%d", arg);
80104aec:	83 ec 08             	sub    $0x8,%esp
80104aef:	ff 76 04             	push   0x4(%esi)
80104af2:	68 cb 7a 10 80       	push   $0x80107acb
80104af7:	e8 a4 bb ff ff       	call   801006a0 <cprintf>
          if(i < 2) cprintf(", ");
80104afc:	83 c4 10             	add    $0x10,%esp
80104aff:	83 fb 02             	cmp    $0x2,%ebx
80104b02:	74 18                	je     80104b1c <syscall+0xbc>
80104b04:	83 ec 0c             	sub    $0xc,%esp
80104b07:	68 ce 7a 10 80       	push   $0x80107ace
80104b0c:	e8 8f bb ff ff       	call   801006a0 <cprintf>
80104b11:	83 c4 10             	add    $0x10,%esp
      for(int i = 0; i < 3; i++){
80104b14:	83 c3 01             	add    $0x1,%ebx
80104b17:	83 fb 03             	cmp    $0x3,%ebx
80104b1a:	75 ad                	jne    80104ac9 <syscall+0x69>
        }
      }
      cprintf(")\n");
80104b1c:	83 ec 0c             	sub    $0xc,%esp
80104b1f:	68 56 7e 10 80       	push   $0x80107e56
80104b24:	e8 77 bb ff ff       	call   801006a0 <cprintf>
...
80104b34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      curproc->pid, curproc->name, num);
80104b38:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104b3b:	56                   	push   %esi
80104b3c:	50                   	push   %eax
80104b3d:	ff 73 10             	push   0x10(%ebx)
80104b40:	68 d1 7a 10 80       	push   $0x80107ad1
...
80104b57:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104b5a:	5b                   	pop    %ebx
80104b5b:	5e                   	pop    %esi
80104b5c:	5f                   	pop    %edi
80104b5d:	5d                   	pop    %ebp
...
80104c94:	68 38 7c 10 80       	push   $0x80107c38
...
80104cac:	68 37 7c 10 80       	push   $0x80107c37
...
80104cc1:	68 2b 7c 10 80       	push   $0x80107c2b
...
80104cdf:	68 3a 7c 10 80       	push   $0x80107c3a
80104ce4:	e8 97 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ce9:	83 ec 0c             	sub    $0xc,%esp
80104cec:	68 1c 7c 10 80       	push   $0x80107c1c
...
801050ed:	58                   	pop    %eax
801050ee:	5a                   	pop    %edx
801050ef:	68 38 7c 10 80       	push   $0x80107c38
...
80105108:	68 37 7c 10 80       	push   $0x80107c37
...
80105434:	e8 a7 f5 ff ff       	call   801049e0 <argstr>
...
80105449:	e8 d2 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010545e:	e8 bd f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
801054b5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054b8:	e8 b3 e4 ff ff       	call   80103970 <myproc>
...
801054cd:	e8 0e f5 ff ff       	call   801049e0 <argstr>
...
80105575:	e8 66 f4 ff ff       	call   801049e0 <argstr>
...
80105591:	e8 8a f3 ff ff       	call   80104920 <argint>
...
801055b0:	e8 ab f0 ff ff       	call   80104660 <memset>
...
801055da:	e8 b1 f2 ff ff       	call   80104890 <fetchint>
...
801055f8:	e8 d3 f2 ff ff       	call   801048d0 <fetchstr>
...
80105661:	e8 0a f3 ff ff       	call   80104970 <argptr>
...
80105687:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105689:	e8 e2 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ca:	e8 a1 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105720:	e9 eb e3 ff ff       	jmp    80103b10 <fork>
...
80105733:	83 ec 08             	sub    $0x8,%esp
  exit();
80105736:	e8 55 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105740:	e9 7b e7 ff ff       	jmp    80103ec0 <wait>
...
8010575c:	e8 bf f1 ff ff       	call   80104920 <argint>
...
8010576e:	e8 ed e9 ff ff       	call   80104160 <kill>
...
80105793:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105796:	e8 d5 e1 ff ff       	call   80103970 <myproc>
...
80105810:	68 20 3d 11 80       	push   $0x80113d20
80105815:	e8 86 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010581a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010581d:	8b 1d 00 3d 11 80    	mov    0x80113d00,%ebx
  while(ticks - ticks0 < n){
...
80105833:	68 20 3d 11 80       	push   $0x80113d20
80105838:	68 00 3d 11 80       	push   $0x80113d00
8010583d:	e8 fe e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105842:	a1 00 3d 11 80       	mov    0x80113d00,%eax
...
80105860:	68 20 3d 11 80       	push   $0x80113d20
...
80105883:	68 20 3d 11 80       	push   $0x80113d20
...
801058a4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801058a7:	68 20 3d 11 80       	push   $0x80113d20
801058ac:	e8 ef ec ff ff       	call   801045a0 <acquire>
  xticks = ticks;
801058b1:	8b 1d 00 3d 11 80    	mov    0x80113d00,%ebx
  release(&tickslock);
801058b7:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
...
801058e6:	78 0c                	js     801058f4 <sys_trace+0x24>
    return -1;

  trace_syscalls = enable;
801058e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058eb:	a3 e8 3c 11 80       	mov    %eax,0x80113ce8
...
80105911:	e8 5a f0 ff ff       	call   80104970 <argptr>
80105916:	83 c4 10             	add    $0x10,%esp
80105919:	85 c0                	test   %eax,%eax
8010591b:	0f 88 94 00 00 00    	js     801059b5 <sys_getuptimeinfo+0xb5>
    return -1;

  addr[0] = ticks;
80105921:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105924:	8b 15 00 3d 11 80    	mov    0x80113d00,%edx
  int runnable = 0;
  int sleeping = 0;
...
8010592a:	83 ec 0c             	sub    $0xc,%esp
  int sleeping = 0;
8010592d:	31 db                	xor    %ebx,%ebx
  int runnable = 0;
8010592f:	31 f6                	xor    %esi,%esi
  int running = 0;
80105931:	31 ff                	xor    %edi,%edi
  addr[0] = ticks;
80105933:	89 10                	mov    %edx,(%eax)
  acquire(&ptable.lock);  // ← IMPORTANTE para sincronización
80105935:	68 40 1d 11 80       	push   $0x80111d40
8010593a:	e8 61 ec ff ff       	call   801045a0 <acquire>
8010593f:	83 c4 10             	add    $0x10,%esp

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105942:	b8 74 1d 11 80       	mov    $0x80111d74,%eax
80105947:	eb 1c                	jmp    80105965 <sys_getuptimeinfo+0x65>
80105949:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      ...
      case SLEEPING:
        sleeping++;
80105950:	83 fa 02             	cmp    $0x2,%edx
80105953:	0f 94 c2             	sete   %dl
80105956:	0f b6 d2             	movzbl %dl,%edx
80105959:	01 d3                	add    %edx,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010595b:	83 c0 7c             	add    $0x7c,%eax
8010595e:	3d 74 3c 11 80       	cmp    $0x80113c74,%eax
80105963:	74 1a                	je     8010597f <sys_getuptimeinfo+0x7f>
    switch(p->state){
80105965:	8b 50 0c             	mov    0xc(%eax),%edx
80105968:	83 fa 03             	cmp    $0x3,%edx
8010596b:	74 43                	je     801059b0 <sys_getuptimeinfo+0xb0>
8010596d:	83 fa 04             	cmp    $0x4,%edx
80105970:	75 de                	jne    80105950 <sys_getuptimeinfo+0x50>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105972:	83 c0 7c             	add    $0x7c,%eax
        running++;
80105975:	83 c7 01             	add    $0x1,%edi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80105978:	3d 74 3c 11 80       	cmp    $0x80113c74,%eax
8010597d:	75 e6                	jne    80105965 <sys_getuptimeinfo+0x65>
...
80105982:	68 40 1d 11 80       	push   $0x80111d40
80105987:	e8 b4 eb ff ff       	call   80104540 <release>
...
8010598c:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  ...
  addr[3] = sleeping;
  addr[4] = ncontext;
8010598f:	8b 15 20 1d 11 80    	mov    0x80111d20,%edx

  return 0;
80105995:	83 c4 10             	add    $0x10,%esp
  addr[1] = running;
80105998:	89 78 04             	mov    %edi,0x4(%eax)
  addr[2] = runnable;
8010599b:	89 70 08             	mov    %esi,0x8(%eax)
  addr[3] = sleeping;
8010599e:	89 58 0c             	mov    %ebx,0xc(%eax)
  addr[4] = ncontext;
801059a1:	89 50 10             	mov    %edx,0x10(%eax)
  return 0;
801059a4:	31 c0                	xor    %eax,%eax
}
801059a6:	8d 65 f4             	lea    -0xc(%ebp),%esp
801059a9:	5b                   	pop    %ebx
801059aa:	5e                   	pop    %esi
801059ab:	5f                   	pop    %edi
801059ac:	5d                   	pop    %ebp
...
801059ae:	66 90                	xchg   %ax,%ax
        runnable++;
801059b0:	83 c6 01             	add    $0x1,%esi
        break;
801059b3:	eb a6                	jmp    8010595b <sys_getuptimeinfo+0x5b>
    return -1;
801059b5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059ba:	eb ea                	jmp    801059a6 <sys_getuptimeinfo+0xa6>
...
801059c9:	83 ec 20             	sub    $0x20,%esp
  if(argptr(0, (char**)&up, sizeof(struct uproc)*64) < 0)
801059cc:	68 00 07 00 00       	push   $0x700
801059d1:	50                   	push   %eax
801059d2:	6a 00                	push   $0x0
801059d4:	e8 97 ef ff ff       	call   80104970 <argptr>
801059d9:	83 c4 10             	add    $0x10,%esp
801059dc:	85 c0                	test   %eax,%eax
801059de:	78 75                	js     80105a55 <sys_getps+0x95>
    return -1;
  if(argint(1, &max) < 0)
...
801059e9:	e8 32 ef ff ff       	call   80104920 <argint>
801059ee:	83 c4 10             	add    $0x10,%esp
801059f1:	85 c0                	test   %eax,%eax
801059f3:	78 60                	js     80105a55 <sys_getps+0x95>
801059f5:	bb e0 1d 11 80       	mov    $0x80111de0,%ebx
801059fa:	be e0 3c 11 80       	mov    $0x80113ce0,%esi
    return -1;

  int count = 0;
801059ff:	31 ff                	xor    %edi,%edi
80105a01:	eb 43                	jmp    80105a46 <sys_getps+0x86>
...
80105a08:	8b 43 a0             	mov    -0x60(%ebx),%eax
80105a0b:	85 c0                	test   %eax,%eax
80105a0d:	74 30                	je     80105a3f <sys_getps+0x7f>

    up[count].pid = p->pid;
80105a0f:	6b c7 1c             	imul   $0x1c,%edi,%eax
80105a12:	8b 4b a4             	mov    -0x5c(%ebx),%ecx
80105a15:	8b 55 e0             	mov    -0x20(%ebp),%edx
    up[count].state = p->state;
    up[count].sz = p->sz;
    safestrcpy(up[count].name, p->name, 16);
80105a18:	83 ec 04             	sub    $0x4,%esp

    count++;
80105a1b:	83 c7 01             	add    $0x1,%edi
    up[count].pid = p->pid;
80105a1e:	89 0c 02             	mov    %ecx,(%edx,%eax,1)
    up[count].state = p->state;
80105a21:	8b 53 a0             	mov    -0x60(%ebx),%edx
80105a24:	03 45 e0             	add    -0x20(%ebp),%eax
80105a27:	89 50 04             	mov    %edx,0x4(%eax)
    up[count].sz = p->sz;
80105a2a:	8b 53 94             	mov    -0x6c(%ebx),%edx
    safestrcpy(up[count].name, p->name, 16);
80105a2d:	83 c0 0c             	add    $0xc,%eax
    up[count].sz = p->sz;
80105a30:	89 50 fc             	mov    %edx,-0x4(%eax)
    safestrcpy(up[count].name, p->name, 16);
80105a33:	6a 10                	push   $0x10
80105a35:	53                   	push   %ebx
80105a36:	50                   	push   %eax
80105a37:	e8 e4 ed ff ff       	call   80104820 <safestrcpy>
    count++;
80105a3c:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC] && count < max; p++){
80105a3f:	83 c3 7c             	add    $0x7c,%ebx
80105a42:	39 de                	cmp    %ebx,%esi
80105a44:	74 05                	je     80105a4b <sys_getps+0x8b>
80105a46:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80105a49:	7f bd                	jg     80105a08 <sys_getps+0x48>
  }

  return count;
}
80105a4b:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80105a54:	c3                   	ret    
    return -1;
80105a55:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80105a5a:	eb ef                	jmp    80105a4b <sys_getps+0x8b>
80105a5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105a60 <sys_getsyscount>:
...
80105a69:	68 00 01 00 00       	push   $0x100
...
80105a7b:	78 3c                	js     80105ab9 <sys_getsyscount+0x59>
        return -1;

    if(argint(1, &size) < 0)
80105a7d:	83 ec 08             	sub    $0x8,%esp
80105a80:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a83:	50                   	push   %eax
80105a84:	6a 01                	push   $0x1
80105a86:	e8 95 ee ff ff       	call   80104920 <argint>
80105a8b:	83 c4 10             	add    $0x10,%esp
80105a8e:	85 c0                	test   %eax,%eax
80105a90:	78 27                	js     80105ab9 <sys_getsyscount+0x59>
        return -1;

    for(int i = 0; i < size; i++)
80105a92:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a95:	31 c0                	xor    %eax,%eax
80105a97:	85 d2                	test   %edx,%edx
80105a99:	7e 1a                	jle    80105ab5 <sys_getsyscount+0x55>
80105a9b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105a9f:	90                   	nop
        buf[i] = syscall_count[i];
80105aa0:	8b 0c 85 80 3c 11 80 	mov    -0x7feec380(,%eax,4),%ecx
80105aa7:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105aaa:	89 0c 82             	mov    %ecx,(%edx,%eax,4)
    for(int i = 0; i < size; i++)
80105aad:	83 c0 01             	add    $0x1,%eax
80105ab0:	39 45 f4             	cmp    %eax,-0xc(%ebp)
80105ab3:	7f eb                	jg     80105aa0 <sys_getsyscount+0x40>
...
80105ac1:	06                   	push   %es
  pushl %fs
80105ac2:	0f a0                	push   %fs
  pushl %gs
80105ac4:	0f a8                	push   %gs
  pushal
80105ac6:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105ac7:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105acb:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105acd:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105acf:	54                   	push   %esp
  call trap
80105ad0:	e8 cb 00 00 00       	call   80105ba0 <trap>
  addl $4, %esp
...
80105ad8:	61                   	popa   
  popl %gs
80105ad9:	0f a9                	pop    %gs
  popl %fs
80105adb:	0f a1                	pop    %fs
  popl %es
80105add:	07                   	pop    %es
  popl %ds
80105ade:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105adf:	83 c4 08             	add    $0x8,%esp
  iret
80105ae2:	cf                   	iret   
...
80105b07:	c7 04 c5 62 3d 11 80 	movl   $0x8e000008,-0x7feec29e(,%eax,8)
80105b0e:	08 00 00 8e 
80105b12:	66 89 14 c5 60 3d 11 	mov    %dx,-0x7feec2a0(,%eax,8)
80105b19:	80 
80105b1a:	c1 ea 10             	shr    $0x10,%edx
80105b1d:	66 89 14 c5 66 3d 11 	mov    %dx,-0x7feec29a(,%eax,8)
80105b24:	80 
  for(i = 0; i < 256; i++)
...
80105b37:	c7 05 62 3f 11 80 08 	movl   $0xef000008,0x80113f62
80105b3e:	00 00 ef 
  initlock(&tickslock, "time");
80105b41:	68 1b 7b 10 80       	push   $0x80107b1b
80105b46:	68 20 3d 11 80       	push   $0x80113d20
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b4b:	66 a3 60 3f 11 80    	mov    %ax,0x80113f60
80105b51:	c1 e8 10             	shr    $0x10,%eax
80105b54:	66 a3 66 3f 11 80    	mov    %ax,0x80113f66
  initlock(&tickslock, "time");
80105b5a:	e8 71 e8 ff ff       	call   801043d0 <initlock>
}
...
80105b7b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b7f:	b8 60 3d 11 80       	mov    $0x80113d60,%eax
...
80105bc4:	ff 24 85 20 7d 10 80 	jmp    *-0x7fef82e0(,%eax,4)
...
80105c12:	0f 84 b8 00 00 00    	je     80105cd0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c18:	e8 53 dd ff ff       	call   80103970 <myproc>
80105c1d:	85 c0                	test   %eax,%eax
80105c1f:	74 1d                	je     80105c3e <trap+0x9e>
80105c21:	e8 4a dd ff ff       	call   80103970 <myproc>
...
80105c81:	e8 ea dc ff ff       	call   80103970 <myproc>
...
80105ca5:	68 dc 7c 10 80       	push   $0x80107cdc
80105caa:	e8 f1 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105caf:	83 c4 20             	add    $0x20,%esp
80105cb2:	e8 b9 dc ff ff       	call   80103970 <myproc>
80105cb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cbe:	e8 ad dc ff ff       	call   80103970 <myproc>
...
80105cd4:	0f 85 3e ff ff ff    	jne    80105c18 <trap+0x78>
    yield();
80105cda:	e8 11 e3 ff ff       	call   80103ff0 <yield>
...
80105cef:	e8 5c dc ff ff       	call   80103950 <cpuid>
80105cf4:	57                   	push   %edi
80105cf5:	56                   	push   %esi
80105cf6:	50                   	push   %eax
80105cf7:	68 84 7c 10 80       	push   $0x80107c84
...
80105d1f:	90                   	nop
    if(myproc()->killed)
80105d20:	e8 4b dc ff ff       	call   80103970 <myproc>
...
80105d35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d38:	e8 23 ed ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105d3d:	e8 2e dc ff ff       	call   80103970 <myproc>
...
80105d53:	5d                   	pop    %ebp
      exit();
80105d54:	e9 37 e0 ff ff       	jmp    80103d90 <exit>
...
80105db0:	68 20 3d 11 80       	push   $0x80113d20
80105db5:	e8 e6 e7 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105dba:	c7 04 24 00 3d 11 80 	movl   $0x80113d00,(%esp)
      ticks++;
80105dc1:	83 05 00 3d 11 80 01 	addl   $0x1,0x80113d00
      wakeup(&ticks);
80105dc8:	e8 33 e3 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105dcd:	c7 04 24 20 3d 11 80 	movl   $0x80113d20,(%esp)
80105dd4:	e8 67 e7 ff ff       	call   80104540 <release>
...
80105de1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105de8:	e8 a3 df ff ff       	call   80103d90 <exit>
...
{
  if(!uart)
80105e30:	a1 60 45 11 80       	mov    0x80114560,%eax
...
80105eb7:	74 78                	je     80105f31 <uartinit+0xd1>
  uart = 1;
80105eb9:	c7 05 60 45 11 80 01 	movl   $0x1,0x80114560
80105ec0:	00 00 00 
...
80105ecc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ecf:	bf a0 7d 10 80       	mov    $0x80107da0,%edi
...
80105ee9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105ef0:	a1 60 45 11 80       	mov    0x80114560,%eax
...
80105f40 <uartputc>:
  if(!uart)
80105f40:	a1 60 45 11 80       	mov    0x80114560,%eax
...
80105fb7:	6a 00                	push   $0x0
  jmp alltraps
80105fb9:	e9 02 fb ff ff       	jmp    80105ac0 <alltraps>
...
80105fc0:	6a 01                	push   $0x1
  jmp alltraps
80105fc2:	e9 f9 fa ff ff       	jmp    80105ac0 <alltraps>
...
80105fc9:	6a 02                	push   $0x2
  jmp alltraps
80105fcb:	e9 f0 fa ff ff       	jmp    80105ac0 <alltraps>
...
80105fd2:	6a 03                	push   $0x3
  jmp alltraps
80105fd4:	e9 e7 fa ff ff       	jmp    80105ac0 <alltraps>
...
80105fdb:	6a 04                	push   $0x4
  jmp alltraps
80105fdd:	e9 de fa ff ff       	jmp    80105ac0 <alltraps>
...
80105fe4:	6a 05                	push   $0x5
  jmp alltraps
80105fe6:	e9 d5 fa ff ff       	jmp    80105ac0 <alltraps>
...
80105fed:	6a 06                	push   $0x6
  jmp alltraps
80105fef:	e9 cc fa ff ff       	jmp    80105ac0 <alltraps>
...
80105ff6:	6a 07                	push   $0x7
  jmp alltraps
80105ff8:	e9 c3 fa ff ff       	jmp    80105ac0 <alltraps>
...
80105ffd:	6a 08                	push   $0x8
  jmp alltraps
80105fff:	e9 bc fa ff ff       	jmp    80105ac0 <alltraps>
...
80106006:	6a 09                	push   $0x9
  jmp alltraps
80106008:	e9 b3 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010600d:	6a 0a                	push   $0xa
  jmp alltraps
8010600f:	e9 ac fa ff ff       	jmp    80105ac0 <alltraps>
...
80106014:	6a 0b                	push   $0xb
  jmp alltraps
80106016:	e9 a5 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010601b:	6a 0c                	push   $0xc
  jmp alltraps
8010601d:	e9 9e fa ff ff       	jmp    80105ac0 <alltraps>
...
80106022:	6a 0d                	push   $0xd
  jmp alltraps
80106024:	e9 97 fa ff ff       	jmp    80105ac0 <alltraps>
...
80106029:	6a 0e                	push   $0xe
  jmp alltraps
8010602b:	e9 90 fa ff ff       	jmp    80105ac0 <alltraps>
...
80106032:	6a 0f                	push   $0xf
  jmp alltraps
80106034:	e9 87 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010603b:	6a 10                	push   $0x10
  jmp alltraps
8010603d:	e9 7e fa ff ff       	jmp    80105ac0 <alltraps>
...
80106042:	6a 11                	push   $0x11
  jmp alltraps
80106044:	e9 77 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010604b:	6a 12                	push   $0x12
  jmp alltraps
8010604d:	e9 6e fa ff ff       	jmp    80105ac0 <alltraps>
...
80106054:	6a 13                	push   $0x13
  jmp alltraps
80106056:	e9 65 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010605d:	6a 14                	push   $0x14
  jmp alltraps
8010605f:	e9 5c fa ff ff       	jmp    80105ac0 <alltraps>
...
80106066:	6a 15                	push   $0x15
  jmp alltraps
80106068:	e9 53 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010606f:	6a 16                	push   $0x16
  jmp alltraps
80106071:	e9 4a fa ff ff       	jmp    80105ac0 <alltraps>
...
80106078:	6a 17                	push   $0x17
  jmp alltraps
8010607a:	e9 41 fa ff ff       	jmp    80105ac0 <alltraps>
...
80106081:	6a 18                	push   $0x18
  jmp alltraps
80106083:	e9 38 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010608a:	6a 19                	push   $0x19
  jmp alltraps
8010608c:	e9 2f fa ff ff       	jmp    80105ac0 <alltraps>
...
80106093:	6a 1a                	push   $0x1a
  jmp alltraps
80106095:	e9 26 fa ff ff       	jmp    80105ac0 <alltraps>
...
8010609c:	6a 1b                	push   $0x1b
  jmp alltraps
8010609e:	e9 1d fa ff ff       	jmp    80105ac0 <alltraps>
...
801060a5:	6a 1c                	push   $0x1c
  jmp alltraps
801060a7:	e9 14 fa ff ff       	jmp    80105ac0 <alltraps>
...
801060ae:	6a 1d                	push   $0x1d
  jmp alltraps
801060b0:	e9 0b fa ff ff       	jmp    80105ac0 <alltraps>
...
801060b7:	6a 1e                	push   $0x1e
  jmp alltraps
801060b9:	e9 02 fa ff ff       	jmp    80105ac0 <alltraps>
...
801060c0:	6a 1f                	push   $0x1f
  jmp alltraps
801060c2:	e9 f9 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060c9:	6a 20                	push   $0x20
  jmp alltraps
801060cb:	e9 f0 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060d2:	6a 21                	push   $0x21
  jmp alltraps
801060d4:	e9 e7 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060db:	6a 22                	push   $0x22
  jmp alltraps
801060dd:	e9 de f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060e4:	6a 23                	push   $0x23
  jmp alltraps
801060e6:	e9 d5 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060ed:	6a 24                	push   $0x24
  jmp alltraps
801060ef:	e9 cc f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060f6:	6a 25                	push   $0x25
  jmp alltraps
801060f8:	e9 c3 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801060ff:	6a 26                	push   $0x26
  jmp alltraps
80106101:	e9 ba f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106108:	6a 27                	push   $0x27
  jmp alltraps
8010610a:	e9 b1 f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106111:	6a 28                	push   $0x28
  jmp alltraps
80106113:	e9 a8 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010611a:	6a 29                	push   $0x29
  jmp alltraps
8010611c:	e9 9f f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106123:	6a 2a                	push   $0x2a
  jmp alltraps
80106125:	e9 96 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010612c:	6a 2b                	push   $0x2b
  jmp alltraps
8010612e:	e9 8d f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106135:	6a 2c                	push   $0x2c
  jmp alltraps
80106137:	e9 84 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010613e:	6a 2d                	push   $0x2d
  jmp alltraps
80106140:	e9 7b f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106147:	6a 2e                	push   $0x2e
  jmp alltraps
80106149:	e9 72 f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106150:	6a 2f                	push   $0x2f
  jmp alltraps
80106152:	e9 69 f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106159:	6a 30                	push   $0x30
  jmp alltraps
8010615b:	e9 60 f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106162:	6a 31                	push   $0x31
  jmp alltraps
80106164:	e9 57 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010616b:	6a 32                	push   $0x32
  jmp alltraps
8010616d:	e9 4e f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106174:	6a 33                	push   $0x33
  jmp alltraps
80106176:	e9 45 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010617d:	6a 34                	push   $0x34
  jmp alltraps
8010617f:	e9 3c f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106186:	6a 35                	push   $0x35
  jmp alltraps
80106188:	e9 33 f9 ff ff       	jmp    80105ac0 <alltraps>
...
8010618f:	6a 36                	push   $0x36
  jmp alltraps
80106191:	e9 2a f9 ff ff       	jmp    80105ac0 <alltraps>
...
80106198:	6a 37                	push   $0x37
  jmp alltraps
8010619a:	e9 21 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801061a1:	6a 38                	push   $0x38
  jmp alltraps
801061a3:	e9 18 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801061aa:	6a 39                	push   $0x39
  jmp alltraps
801061ac:	e9 0f f9 ff ff       	jmp    80105ac0 <alltraps>
...
801061b3:	6a 3a                	push   $0x3a
  jmp alltraps
801061b5:	e9 06 f9 ff ff       	jmp    80105ac0 <alltraps>
...
801061bc:	6a 3b                	push   $0x3b
  jmp alltraps
801061be:	e9 fd f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061c5:	6a 3c                	push   $0x3c
  jmp alltraps
801061c7:	e9 f4 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061ce:	6a 3d                	push   $0x3d
  jmp alltraps
801061d0:	e9 eb f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061d7:	6a 3e                	push   $0x3e
  jmp alltraps
801061d9:	e9 e2 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061e0:	6a 3f                	push   $0x3f
  jmp alltraps
801061e2:	e9 d9 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061e9:	6a 40                	push   $0x40
  jmp alltraps
801061eb:	e9 d0 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061f2:	6a 41                	push   $0x41
  jmp alltraps
801061f4:	e9 c7 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801061fb:	6a 42                	push   $0x42
  jmp alltraps
801061fd:	e9 be f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106204:	6a 43                	push   $0x43
  jmp alltraps
80106206:	e9 b5 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010620d:	6a 44                	push   $0x44
  jmp alltraps
8010620f:	e9 ac f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106216:	6a 45                	push   $0x45
  jmp alltraps
80106218:	e9 a3 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010621f:	6a 46                	push   $0x46
  jmp alltraps
80106221:	e9 9a f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106228:	6a 47                	push   $0x47
  jmp alltraps
8010622a:	e9 91 f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106231:	6a 48                	push   $0x48
  jmp alltraps
80106233:	e9 88 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010623a:	6a 49                	push   $0x49
  jmp alltraps
8010623c:	e9 7f f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106243:	6a 4a                	push   $0x4a
  jmp alltraps
80106245:	e9 76 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010624c:	6a 4b                	push   $0x4b
  jmp alltraps
8010624e:	e9 6d f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106255:	6a 4c                	push   $0x4c
  jmp alltraps
80106257:	e9 64 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010625e:	6a 4d                	push   $0x4d
  jmp alltraps
80106260:	e9 5b f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106267:	6a 4e                	push   $0x4e
  jmp alltraps
80106269:	e9 52 f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106270:	6a 4f                	push   $0x4f
  jmp alltraps
80106272:	e9 49 f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106279:	6a 50                	push   $0x50
  jmp alltraps
8010627b:	e9 40 f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106282:	6a 51                	push   $0x51
  jmp alltraps
80106284:	e9 37 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010628b:	6a 52                	push   $0x52
  jmp alltraps
8010628d:	e9 2e f8 ff ff       	jmp    80105ac0 <alltraps>
...
80106294:	6a 53                	push   $0x53
  jmp alltraps
80106296:	e9 25 f8 ff ff       	jmp    80105ac0 <alltraps>
...
8010629d:	6a 54                	push   $0x54
  jmp alltraps
8010629f:	e9 1c f8 ff ff       	jmp    80105ac0 <alltraps>
...
801062a6:	6a 55                	push   $0x55
  jmp alltraps
801062a8:	e9 13 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801062af:	6a 56                	push   $0x56
  jmp alltraps
801062b1:	e9 0a f8 ff ff       	jmp    80105ac0 <alltraps>
...
801062b8:	6a 57                	push   $0x57
  jmp alltraps
801062ba:	e9 01 f8 ff ff       	jmp    80105ac0 <alltraps>
...
801062c1:	6a 58                	push   $0x58
  jmp alltraps
801062c3:	e9 f8 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062ca:	6a 59                	push   $0x59
  jmp alltraps
801062cc:	e9 ef f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062d3:	6a 5a                	push   $0x5a
  jmp alltraps
801062d5:	e9 e6 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062dc:	6a 5b                	push   $0x5b
  jmp alltraps
801062de:	e9 dd f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062e5:	6a 5c                	push   $0x5c
  jmp alltraps
801062e7:	e9 d4 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062ee:	6a 5d                	push   $0x5d
  jmp alltraps
801062f0:	e9 cb f7 ff ff       	jmp    80105ac0 <alltraps>
...
801062f7:	6a 5e                	push   $0x5e
  jmp alltraps
801062f9:	e9 c2 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106300:	6a 5f                	push   $0x5f
  jmp alltraps
80106302:	e9 b9 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106309:	6a 60                	push   $0x60
  jmp alltraps
8010630b:	e9 b0 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106312:	6a 61                	push   $0x61
  jmp alltraps
80106314:	e9 a7 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010631b:	6a 62                	push   $0x62
  jmp alltraps
8010631d:	e9 9e f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106324:	6a 63                	push   $0x63
  jmp alltraps
80106326:	e9 95 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010632d:	6a 64                	push   $0x64
  jmp alltraps
8010632f:	e9 8c f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106336:	6a 65                	push   $0x65
  jmp alltraps
80106338:	e9 83 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010633f:	6a 66                	push   $0x66
  jmp alltraps
80106341:	e9 7a f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106348:	6a 67                	push   $0x67
  jmp alltraps
8010634a:	e9 71 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106351:	6a 68                	push   $0x68
  jmp alltraps
80106353:	e9 68 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010635a:	6a 69                	push   $0x69
  jmp alltraps
8010635c:	e9 5f f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106363:	6a 6a                	push   $0x6a
  jmp alltraps
80106365:	e9 56 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010636c:	6a 6b                	push   $0x6b
  jmp alltraps
8010636e:	e9 4d f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106375:	6a 6c                	push   $0x6c
  jmp alltraps
80106377:	e9 44 f7 ff ff       	jmp    80105ac0 <alltraps>
...
8010637e:	6a 6d                	push   $0x6d
  jmp alltraps
80106380:	e9 3b f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106387:	6a 6e                	push   $0x6e
  jmp alltraps
80106389:	e9 32 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106390:	6a 6f                	push   $0x6f
  jmp alltraps
80106392:	e9 29 f7 ff ff       	jmp    80105ac0 <alltraps>
...
80106399:	6a 70                	push   $0x70
  jmp alltraps
8010639b:	e9 20 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801063a2:	6a 71                	push   $0x71
  jmp alltraps
801063a4:	e9 17 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801063ab:	6a 72                	push   $0x72
  jmp alltraps
801063ad:	e9 0e f7 ff ff       	jmp    80105ac0 <alltraps>
...
801063b4:	6a 73                	push   $0x73
  jmp alltraps
801063b6:	e9 05 f7 ff ff       	jmp    80105ac0 <alltraps>
...
801063bd:	6a 74                	push   $0x74
  jmp alltraps
801063bf:	e9 fc f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063c6:	6a 75                	push   $0x75
  jmp alltraps
801063c8:	e9 f3 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063cf:	6a 76                	push   $0x76
  jmp alltraps
801063d1:	e9 ea f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063d8:	6a 77                	push   $0x77
  jmp alltraps
801063da:	e9 e1 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063e1:	6a 78                	push   $0x78
  jmp alltraps
801063e3:	e9 d8 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063ea:	6a 79                	push   $0x79
  jmp alltraps
801063ec:	e9 cf f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063f3:	6a 7a                	push   $0x7a
  jmp alltraps
801063f5:	e9 c6 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801063fc:	6a 7b                	push   $0x7b
  jmp alltraps
801063fe:	e9 bd f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106405:	6a 7c                	push   $0x7c
  jmp alltraps
80106407:	e9 b4 f6 ff ff       	jmp    80105ac0 <alltraps>
...
8010640e:	6a 7d                	push   $0x7d
  jmp alltraps
80106410:	e9 ab f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106417:	6a 7e                	push   $0x7e
  jmp alltraps
80106419:	e9 a2 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106420:	6a 7f                	push   $0x7f
  jmp alltraps
80106422:	e9 99 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106429:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010642e:	e9 8d f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106435:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010643a:	e9 81 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106441:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106446:	e9 75 f6 ff ff       	jmp    80105ac0 <alltraps>
...
8010644d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106452:	e9 69 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106459:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010645e:	e9 5d f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106465:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010646a:	e9 51 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106471:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106476:	e9 45 f6 ff ff       	jmp    80105ac0 <alltraps>
...
8010647d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106482:	e9 39 f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106489:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010648e:	e9 2d f6 ff ff       	jmp    80105ac0 <alltraps>
...
80106495:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010649a:	e9 21 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801064a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801064a6:	e9 15 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801064ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801064b2:	e9 09 f6 ff ff       	jmp    80105ac0 <alltraps>
...
801064b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801064be:	e9 fd f5 ff ff       	jmp    80105ac0 <alltraps>
...
801064c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801064ca:	e9 f1 f5 ff ff       	jmp    80105ac0 <alltraps>
...
801064d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801064d6:	e9 e5 f5 ff ff       	jmp    80105ac0 <alltraps>
...
801064dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801064e2:	e9 d9 f5 ff ff       	jmp    80105ac0 <alltraps>
...
801064e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801064ee:	e9 cd f5 ff ff       	jmp    80105ac0 <alltraps>
...
801064f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801064fa:	e9 c1 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106501:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106506:	e9 b5 f5 ff ff       	jmp    80105ac0 <alltraps>
...
8010650d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106512:	e9 a9 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106519:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010651e:	e9 9d f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106525:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010652a:	e9 91 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106531:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106536:	e9 85 f5 ff ff       	jmp    80105ac0 <alltraps>
...
8010653d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106542:	e9 79 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106549:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010654e:	e9 6d f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106555:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010655a:	e9 61 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106561:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106566:	e9 55 f5 ff ff       	jmp    80105ac0 <alltraps>
...
8010656d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106572:	e9 49 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106579:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010657e:	e9 3d f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106585:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010658a:	e9 31 f5 ff ff       	jmp    80105ac0 <alltraps>
...
80106591:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106596:	e9 25 f5 ff ff       	jmp    80105ac0 <alltraps>
...
8010659d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801065a2:	e9 19 f5 ff ff       	jmp    80105ac0 <alltraps>
...
801065a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801065ae:	e9 0d f5 ff ff       	jmp    80105ac0 <alltraps>
...
801065b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801065ba:	e9 01 f5 ff ff       	jmp    80105ac0 <alltraps>
...
801065c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801065c6:	e9 f5 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801065cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801065d2:	e9 e9 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801065d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801065de:	e9 dd f4 ff ff       	jmp    80105ac0 <alltraps>
...
801065e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801065ea:	e9 d1 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801065f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801065f6:	e9 c5 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801065fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106602:	e9 b9 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106609:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010660e:	e9 ad f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106615:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010661a:	e9 a1 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106621:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106626:	e9 95 f4 ff ff       	jmp    80105ac0 <alltraps>
...
8010662d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106632:	e9 89 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106639:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010663e:	e9 7d f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106645:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010664a:	e9 71 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106651:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106656:	e9 65 f4 ff ff       	jmp    80105ac0 <alltraps>
...
8010665d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106662:	e9 59 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106669:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010666e:	e9 4d f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106675:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010667a:	e9 41 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106681:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106686:	e9 35 f4 ff ff       	jmp    80105ac0 <alltraps>
...
8010668d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106692:	e9 29 f4 ff ff       	jmp    80105ac0 <alltraps>
...
80106699:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010669e:	e9 1d f4 ff ff       	jmp    80105ac0 <alltraps>
...
801066a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801066aa:	e9 11 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801066b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801066b6:	e9 05 f4 ff ff       	jmp    80105ac0 <alltraps>
...
801066bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801066c2:	e9 f9 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801066c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801066ce:	e9 ed f3 ff ff       	jmp    80105ac0 <alltraps>
...
801066d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801066da:	e9 e1 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801066e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801066e6:	e9 d5 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801066ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801066f2:	e9 c9 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801066f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801066fe:	e9 bd f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106705:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010670a:	e9 b1 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106711:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106716:	e9 a5 f3 ff ff       	jmp    80105ac0 <alltraps>
...
8010671d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106722:	e9 99 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106729:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010672e:	e9 8d f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106735:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010673a:	e9 81 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106741:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106746:	e9 75 f3 ff ff       	jmp    80105ac0 <alltraps>
...
8010674d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106752:	e9 69 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106759:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010675e:	e9 5d f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106765:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010676a:	e9 51 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106771:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106776:	e9 45 f3 ff ff       	jmp    80105ac0 <alltraps>
...
8010677d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106782:	e9 39 f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106789:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010678e:	e9 2d f3 ff ff       	jmp    80105ac0 <alltraps>
...
80106795:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010679a:	e9 21 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801067a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801067a6:	e9 15 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801067ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801067b2:	e9 09 f3 ff ff       	jmp    80105ac0 <alltraps>
...
801067b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801067be:	e9 fd f2 ff ff       	jmp    80105ac0 <alltraps>
...
801067c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801067ca:	e9 f1 f2 ff ff       	jmp    80105ac0 <alltraps>
...
801067d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801067d6:	e9 e5 f2 ff ff       	jmp    80105ac0 <alltraps>
...
801067dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801067e2:	e9 d9 f2 ff ff       	jmp    80105ac0 <alltraps>
...
801067e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801067ee:	e9 cd f2 ff ff       	jmp    80105ac0 <alltraps>
...
801067f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801067fa:	e9 c1 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106801:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106806:	e9 b5 f2 ff ff       	jmp    80105ac0 <alltraps>
...
8010680d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106812:	e9 a9 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106819:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010681e:	e9 9d f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106825:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010682a:	e9 91 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106831:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106836:	e9 85 f2 ff ff       	jmp    80105ac0 <alltraps>
...
8010683d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106842:	e9 79 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106849:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010684e:	e9 6d f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106855:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010685a:	e9 61 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106861:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106866:	e9 55 f2 ff ff       	jmp    80105ac0 <alltraps>
...
8010686d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106872:	e9 49 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106879:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010687e:	e9 3d f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106885:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010688a:	e9 31 f2 ff ff       	jmp    80105ac0 <alltraps>
...
80106891:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106896:	e9 25 f2 ff ff       	jmp    80105ac0 <alltraps>
...
8010689d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801068a2:	e9 19 f2 ff ff       	jmp    80105ac0 <alltraps>
...
801068a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801068ae:	e9 0d f2 ff ff       	jmp    80105ac0 <alltraps>
...
801068b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801068ba:	e9 01 f2 ff ff       	jmp    80105ac0 <alltraps>
...
801068c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801068c6:	e9 f5 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801068cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801068d2:	e9 e9 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801068d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801068de:	e9 dd f1 ff ff       	jmp    80105ac0 <alltraps>
...
801068e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801068ea:	e9 d1 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801068f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801068f6:	e9 c5 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801068fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106902:	e9 b9 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106909:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010690e:	e9 ad f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106915:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010691a:	e9 a1 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106921:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106926:	e9 95 f1 ff ff       	jmp    80105ac0 <alltraps>
...
8010692d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106932:	e9 89 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106939:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010693e:	e9 7d f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106945:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010694a:	e9 71 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106951:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106956:	e9 65 f1 ff ff       	jmp    80105ac0 <alltraps>
...
8010695d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106962:	e9 59 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106969:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010696e:	e9 4d f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106975:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010697a:	e9 41 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106981:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106986:	e9 35 f1 ff ff       	jmp    80105ac0 <alltraps>
...
8010698d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106992:	e9 29 f1 ff ff       	jmp    80105ac0 <alltraps>
...
80106999:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010699e:	e9 1d f1 ff ff       	jmp    80105ac0 <alltraps>
...
801069a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801069aa:	e9 11 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801069b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801069b6:	e9 05 f1 ff ff       	jmp    80105ac0 <alltraps>
...
801069bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801069c2:	e9 f9 f0 ff ff       	jmp    80105ac0 <alltraps>
...
801069c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801069ce:	e9 ed f0 ff ff       	jmp    80105ac0 <alltraps>
...
801069d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801069da:	e9 e1 f0 ff ff       	jmp    80105ac0 <alltraps>
...
801069e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801069e6:	e9 d5 f0 ff ff       	jmp    80105ac0 <alltraps>
...
801069ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801069f2:	e9 c9 f0 ff ff       	jmp    80105ac0 <alltraps>
...
801069f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801069fe:	e9 bd f0 ff ff       	jmp    80105ac0 <alltraps>
...
80106a05:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106a0a:	e9 b1 f0 ff ff       	jmp    80105ac0 <alltraps>
...
80106a11:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106a16:	e9 a5 f0 ff ff       	jmp    80105ac0 <alltraps>
...
80106a1d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106a22:	e9 99 f0 ff ff       	jmp    80105ac0 <alltraps>
...
80106acf:	68 86 76 10 80       	push   $0x80107686
...
80106b75:	e8 e6 da ff ff       	call   80104660 <memset>
...
80106bbd:	68 a8 7d 10 80       	push   $0x80107da8
...
80106bd3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106bd6:	e8 75 cd ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106c60:	a1 64 45 11 80       	mov    0x80114564,%eax
...
80106c94:	0f 84 c2 00 00 00    	je     80106d5c <switchuvm+0xec>
  pushcli();
80106c9a:	e8 b1 d7 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c9f:	e8 4c cc ff ff       	call   801038f0 <mycpu>
80106ca4:	89 c3                	mov    %eax,%ebx
80106ca6:	e8 45 cc ff ff       	call   801038f0 <mycpu>
80106cab:	89 c7                	mov    %eax,%edi
80106cad:	e8 3e cc ff ff       	call   801038f0 <mycpu>
80106cb2:	83 c7 08             	add    $0x8,%edi
80106cb5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106cb8:	e8 33 cc ff ff       	call   801038f0 <mycpu>
...
80106d01:	e8 ea cb ff ff       	call   801038f0 <mycpu>
80106d06:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d0d:	e8 de cb ff ff       	call   801038f0 <mycpu>
...
80106d24:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d27:	e8 c4 cb ff ff       	call   801038f0 <mycpu>
...
80106daf:	e8 ac d8 ff ff       	call   80104660 <memset>
...
80106de2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106de3:	e9 18 d9 ff ff       	jmp    80104700 <memmove>
...
80106e50:	68 07 7e 10 80       	push   $0x80107e07
...
80106ed8:	68 a8 7e 10 80       	push   $0x80107ea8
...
80106f3b:	e8 20 d7 ff ff       	call   80104660 <memset>
...
80106f79:	68 25 7e 10 80       	push   $0x80107e25
...
80106fdb:	68 3d 7e 10 80       	push   $0x80107e3d
...
801070bc:	68 59 7e 10 80       	push   $0x80107e59
...
801070f0:	e8 6b d5 ff ff       	call   80104660 <memset>
...
8010715b:	a3 64 45 11 80       	mov    %eax,0x80114564
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010718c:	68 6a 7e 10 80       	push   $0x80107e6a
...
80107202:	68 74 7e 10 80       	push   $0x80107e74
...
801072d7:	68 8e 7e 10 80       	push   $0x80107e8e
...
80107390:	e8 6b d3 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
