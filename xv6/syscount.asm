...
_syscount:     formato del fichero elf32-i386
   ...
   f:	8d b5 e8 fe ff ff    	lea    -0x118(%ebp),%esi
{
  15:	53                   	push   %ebx
  16:	51                   	push   %ecx
  17:	81 ec 10 01 00 00    	sub    $0x110,%esp
  1d:	8b 79 04             	mov    0x4(%ecx),%edi
  20:	8b 19                	mov    (%ecx),%ebx
    getsyscount(buf, 64);
  22:	6a 40                	push   $0x40
  24:	56                   	push   %esi
  25:	e8 81 03 00 00       	call   3ab <getsyscount>
  ...
  70:	ff 77 04             	push   0x4(%edi)
  73:	e8 08 02 00 00       	call   280 <atoi>
        printf(1, "Syscall %d fue invocada %d veces\n", id, buf[id]);
  78:	ff b4 85 e8 fe ff ff 	push   -0x118(%ebp,%eax,4)
  7f:	50                   	push   %eax
  80:	68 98 07 00 00       	push   $0x798
  85:	6a 01                	push   $0x1
  87:	e8 e4 03 00 00       	call   470 <printf>
        exit();
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba ea 07 00 00       	mov    $0x7ea,%edx
        while(*s != 0){
